...
def format_prediction_response(
    ...
    prefix = severity_prefix.get(prediction_result["severity"], "[INFO]")

    message_parts.append(f"{prefix} *MediGuard AI Prediction*\n")
    ...
    # Disclaimer
    message_parts.append(
        "\n_Disclaimer: This AI-powered analysis is for informational purposes "
...
- Convert PDF pages to images and send them
...
*Note:* This is an AI assistant for educational and triage purposes. Always consult a healthcare provider for medical decisions.
"""
