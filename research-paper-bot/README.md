...
> AI-powered WhatsApp bot for research paper search, Q&A, and structured summaries via Groq AI.
...
- ✅ Check all required variables are set: `TWILIO_ACCOUNT_SID`, `TWILIO_AUTH_TOKEN`, `GROQ_API_KEY`
